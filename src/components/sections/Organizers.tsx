  ...
  return (
    <section id="organizers" className="py-20 md:py-28 px-4 bg-background" style={{ clipPath: "polygon(0 0, 100% 4vw, 100% 100%, 0 100%)", marginTop: "-4vw" }}>
      <div className="container mx-auto max-w-5xl text-center py-8">
        <div className="inline-block bg-go-blue border-2 border-black text-white px-4 py-1.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-transform mb-6">
          <h2 className="text-3xl md:text-5xl font-black tracking-tighter uppercase">Meet the Team</h2>
        </div>
        <p className="text-lg md:text-xl font-bold text-black mb-12 max-w-2xl mx-auto bg-white border-2 border-black p-3 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          We are passionate Go developers dedicated to building a strong, inclusive local community in Aarhus.
        </p>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          {organizers.map((org) => (
            <div key={org.name} className="bg-white border-2 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all flex flex-col items-center">
