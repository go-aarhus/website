  ...
  return (
    <section id="cfp" className="py-20 md:py-28 px-4 relative bg-go-fuchsia text-white" style={{ clipPath: "polygon(0 0, 100% 4vw, 100% 100%, 0 calc(100% - 4vw))", marginTop: "-4vw", paddingBottom: "10vw" }}>
      <div className="container mx-auto max-w-4xl relative z-10 text-center py-8">
        <div className="inline-flex items-center justify-center p-4 bg-white border-2 border-black text-black mb-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transform transition-transform">
        ...
        <div className="bg-white text-black border-2 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-10">
