export function Footer() {
  return (
    <footer className="border-t-2 border-black py-8 bg-white relative z-20">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4 px-4 text-center md:text-left font-bold">
        ...
        <p className="text-sm md:text-base text-black bg-go-yellow px-3 py-1.5 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
